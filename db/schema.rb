...
ActiveRecord::Schema.define(version: 20_220_629_030_053) do
  ...
  create_table 'creature_types', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.integer 'related_as_mains_count'
  end
  ...
  create_table 'distinctions', force: :cascade do |t|
    ...
    t.index %w[record_type record_id], name: 'index_distinctions_on_record'
  end
